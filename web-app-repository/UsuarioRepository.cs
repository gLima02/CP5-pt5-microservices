...
//importar o domain nos PACKAGES da web-app-repository. --> dependencies -> botão direito -> add Project Reference
...
namespace web_app_repository
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public async Task<IEnumerable<Usuario>> ListarUsuarios()
        {
            ...
            string query = "select Id, Nome, Email from usuarios;"; //retirado da controller
            var usuarios = await mySqlConnection.QueryAsync<Usuario>(query); //usando dapper
